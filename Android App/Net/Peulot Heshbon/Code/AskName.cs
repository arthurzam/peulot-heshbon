    ...
    internal class AskName : Form
    {
        public AskName()
        {
            ...
            for (int i = 0; i < this.Controls.Count; i++)
                Controls[i].KeyUp += this.AskName_KeyUp;
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.KeyUp += new System.Windows.Forms.KeyEventHandler(this.AskName_KeyUp);
        ...
        private void AskName_KeyUp(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Escape:
