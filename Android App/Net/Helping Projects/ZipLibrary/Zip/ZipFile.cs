...
using PeulotHeshbon.ZipLibrary.Encryption;

#endif

using PeulotHeshbon.ZipLibrary.Core;
using PeulotHeshbon.ZipLibrary.Checksums;
using PeulotHeshbon.ZipLibrary.Zip.Compression.Streams;
using PeulotHeshbon.ZipLibrary.Zip.Compression;
...
namespace PeulotHeshbon.ZipLibrary.Zip
{
    ...
    public class ZipFile : IEnumerable, IDisposable
    {
        ...
        /// </exception>
        /// <exception cref="PeulotHeshbon.ZipLibrary.Zip.ZipException">
