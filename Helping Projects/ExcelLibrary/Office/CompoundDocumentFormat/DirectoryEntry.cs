...
namespace ExcelLibrary.CompoundDocumentFormat
{
    ...
    public class DirectoryEntry : IComparable<DirectoryEntry>
    {
        ...
        /// (if this entry is a user storage or stream), –1 if there is no left child
        /// </summary>
        public int LeftChildDID;

        /// <summary>
        /// DID of the right child node inside the red-black tree of all direct members of the parent storage
        /// (if this entry is a user storage or stream), –1 if there is no right child
        /// </summary>
        ...
        /// (if this entry is a storage), –1 otherwise
        /// </summary>
        ...
        #region IComparable<DirectoryEntry> 成员
        ...
        #endregion IComparable<DirectoryEntry> 成员
    }
}